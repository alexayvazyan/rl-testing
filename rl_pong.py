...
replay_experience = ReplayBuffer(100000)
    ...
    if mode == "TRAIN":
        ...
        while not truncated and not terminated:
            ...
            if i<5:
                ...
                replay_experience.push(frames[0:4], action, reward, frames[1:5])
                if len(replay_experience) > 10000:
                    sample_batch = replay_experience.sample(4)
...
for i in range(1, n_episodes):
    ...
    if j % 5 == 0:
        print(j)
pt.save(solver.state_dict(), 'pong_weights.pt')

solver.load_state_dict(pt.load("pong_weights.pt"))
